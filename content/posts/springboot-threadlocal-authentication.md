...
![ThreadLocal 초기화](https://i.imgur.com/LGCxa68.png)
...
![실제 문제 상황](https://i.imgur.com/14aUyjs.png)

토큰 없이 요청했음에도 이전에 조회했던 사용자 정보가 반환되는 현상 확인 후, ThreadLocal 초기화 코드 추가로 해결했습니다.

![해결 후 결과](https://i.imgur.com/JP1EJeI.png)
