...
![변경 전 테이블 구조](/images/posts/beanpay-detail-removal/변경-전-테이블-구조.png)
...
![변경 후 테이블 구조](/images/posts/beanpay-detail-removal/변경-후-테이블-구조.png)

BeanPayDetail 테이블을 제거하고 PaymentDetail로 통합했으며, 토스 API 충전 데이터는 ChargeInfo 테이블로 분리했습니다.

![통합된 구조](/images/posts/beanpay-detail-removal/통합된-구조.png)
